    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 2, "Пройти лабораторные работы 27-36.", new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), false, true, 5, "Изучить ASP.NET Cote", new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc) },
                    ...
                    { 4, 2, "Основные методы для работы с коллекциями и EF Core.", new DateTime(2026, 1, 4, 0, 0, 0, 0, DateTimeKind.Utc), false, true, 4, "Конспект LINQ", new DateTime(2026, 1, 4, 0, 0, 0, 0, DateTimeKind.Utc) },
